...
Route::get('/panier', "App\\Http\\Controllers\\shop\\PanierController@showPanier")->name('panier_show');
Route::post('/panier/promo', "App\\Http\\Controllers\\shop\\PanierController@promo")->name('panier_promo');
Route::post('/panier/add/{id}', "App\\Http\\Controllers\\shop\\PanierController@add")->name('panier_add');
Route::delete('/panier/{id}', "App\\Http\\Controllers\\shop\\PanierController@suppProduit")->name('panier_supp');
Route::delete('/panier/promo/supprimer', "App\\Http\\Controllers\\shop\\PanierController@promoRemove")->name('promo_remove');
